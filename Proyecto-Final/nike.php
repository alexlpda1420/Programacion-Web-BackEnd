...
<body>
  <div class="page-wrapper">
    ...
    <section class="page-hero">
      <div class="container">
        <span class="hero-kicker">Marca destacada</span>
        <h1>Nike</h1>
        <p>Productos cargados en la base de datos que pertenecen a la marca Nike.</p>
      </div>
    </section>

    <main class="products-section">
      <div class="container">
        <h2 class="section-title">Productos Nike</h2>
        <p class="section-description">La siguiente lista muestra los productos de la marca Nike.</p>
        ...
        <div class="text-center mt-5">
          ...
          <a class="btn btn-pink" href="nikexl.php">Ver Nike XL</a>
        </div>
      </div>
    </main>
      ...
      <div class="container">
        <div class="row align-items-center gy-3">
          ...
          <div class="col-md-6 text-md-end">
            ...
            <a class="me-3" href="nikexl.php">Nike XL</a>
